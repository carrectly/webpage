...
const about = () => {
  return (
    <Layout>
        <Typography variant="h4" align="center" gutterBottom component="div" color="text.secondary" padding="30px">
          WHAT WE BELIEVE
        </Typography>

        <Typography gutterBottom component="div" align="center" paddingBottom="30px">
        ...
        <Typography variant="h4" align="center" gutterBottom component="div" padding="30px" color="text.secondary">
          WHAT DRIVES US
        </Typography>
