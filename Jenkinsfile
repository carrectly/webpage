         ...
         stages {
                 ...
                 stage ('image build and Push') {
                    steps {
                            ...
                            """ if [ $(docker ps -aq)]; then docker stop $(docker ps -aq); fi docker pull pavlohortovenko20/carrectlyweb:latest && docker run -d -p 3000:3000 pavlohortovenko20/carrectlyweb:latest """
                            '''
                    }
                }
            }
